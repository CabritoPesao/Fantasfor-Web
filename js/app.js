...
const pathMap={Home:'home',plantation:'plantacao',talents:'talentos','armor-sets':'set-de-armadura',maps:'mapas',masks:'mascaras','build-maker':'build-maker','armor-sets-lacaios':'conju-armaduras',console:'console',status:'status',leather:'couros',confort:'conforto',foods:'comidas',stack:'stack',boss:'boss'};
